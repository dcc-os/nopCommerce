...
namespace Nop.Plugin.Payments.Bkash
{
    ...
    public class BkashPaymentProcessor : BasePlugin, IPaymentMethod
    {
        ...
        public bool HidePaymentMethod(IList<ShoppingCartItem> cart)
        {
            ...
            if (_bkashPaymentSettings.ShippableProductRequired && !cart.RequiresShipping())
                return true;
        ...
        public override void Install()
        {
            ...
            {
                DescriptionText = "<p>If you have a bKash account, please follow the below steps:</p><ol><li>Go to your bKash Mobile Menu by dialing *247#</li><li>Choose &ldquo;Payment&rdquo;</li><li>Enter our bKash Wallet&nbsp;Number : 01XXXXXXXXX</li><li>Enter the amount you want to pay</li><li>Enter a reference against your payment (put your order number)</li><li>Enter the Counter Number (e.g. 1)</li><li>Now enter your bKash Mobile Menu PIN to confirm</li></ol><p>Done! You will receive a confirmation message from bKash.</p><p>P.S. You can edit this text from admin panel.</p>"
            };
            ...
            this.AddOrUpdatePluginLocaleResource("Plugins.Payment.Bkash.ShippableProductRequired", "Shippable product required");
            this.AddOrUpdatePluginLocaleResource("Plugins.Payment.Bkash.ShippableProductRequired.Hint", "An option indicating whether shippable products are required in order to display this payment method during checkout.");
        ...
        public override void Uninstall()
        {
            ...
            this.DeletePluginLocaleResource("Plugins.Payment.Bkash.ShippableProductRequired");
            this.DeletePluginLocaleResource("Plugins.Payment.Bkash.ShippableProductRequired.Hint");
